      ...
      <div style={{display:"grid", grid:"0px / auto auto"}}>
        ...
        <div className="r">
          <ReactDiagram
            ...
            linkDataArray={[
              { from: 1, to: 12, relationship: "aggregation" },
...
//   var res = code.split('\n')
//   for(let x in res){
//     const codeLine = res[x];
//     //if codeline contains class keyword, create box with its name
//     if(codeLine.includes("class") && codeLine.includes('{') && !codeLine.includes('extends')){
//       // console.log("This has a class");
//       var className = codeLine.split(" ");
//       classnames.push(className[1])
//       //make the box here
//       let y = x;
//       let entity = [];
//       while(!res[y].includes("}")){
//         if(!res[y].includes("{")){
//           // console.log(res[y]);
//           entity.push(res[y]);
//           // console.log(entities)
//         }
//           //put contents in respective box here
//           entities.set(x,entity)
//           y++;
//       }
//     }
//     if(codeLine.includes("extends") && codeLine.includes("class")){
